...
#-> HE AÑADIDO EL ARCHIVO APP2 QUE TIENE LO EXIGIDO.
#-> NO PUEDO EJECUTARLO PORQUE PESE A USAR pip install sqlalchemy pandas python-dotenv NO EJECUTA. 
#-> TAMBIEN PROBÉ A pip install --upgrade pip
#-> TAMBIEN LLAMAR ARCHIVO: 
#-> HE AÑADIDO EL ARCHIVO APP2 QUE TIENE LO EXIGIDO.
#-> NO PUEDO EJECUTARLO PORQUE PESE A USAR pip install sqlalchemy pandas python-dotenv NO EJECUTA. 
#-> TAMBIEN PROBÉ A pip install --upgrade pip
#-> TAMBIEN LLAMAR ARCHIVO: python "/workspaces/PROGRAMA-DOOR-PROYECTO13-connecting-to-a-sql-database-project-tutorial/src/app3.py"
